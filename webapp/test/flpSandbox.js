		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comparkerpricechangereport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comparkerpricechangereport-display": {
								"semanticObject": "comparkerpricechangereport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.parker.pricechangereport",
									"url": sap.ui.require.toUrl("com/parker/pricechangereport")
								}
							}
						}
					}
